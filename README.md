...
* [**urllib3**](https://github.com/urllib3/urllib3) - Experimental: Modern HTTP library. Supports Persistent connections. Licensed under [MIT](https://github.com/urllib3/urllib3/blob/main/LICENSE.txt)
* [**PySocks**](https://github.com/Anorov/PySocks) - Experimental: Required for using SOCKS proxies with urllib3. Licensed under [BSD](https://github.com/Anorov/PySocks/blob/master/LICENSE)
* [**brotli**](https://github.com/google/brotli) (CPython) or [**brotlicffi**](https://github.com/python-hyper/brotlicffi) (CPython & pypy) - Experimental: [Brotli](https://en.wikipedia.org/wiki/Brotli) content decoding support. Both variations licensed under [MIT](https://github.com/google/brotli/blob/master/LICENSE)
