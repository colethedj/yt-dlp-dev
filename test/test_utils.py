...
from yt_dlp.utils import (
    ...
    cli_bool_option,
    parse_codecs,
    iri_to_uri, LazyList, str_to_int, parse_count, determine_ext, find_xpath_attr, xpath_with_ns, xpath_element,
    xpath_text, xpath_attr,
)
from yt_dlp.network.utils import sanitize_url, escape_url, escape_rfc3986
from yt_dlp.network.backends import sanitized_Request
